          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
                <form>
                    ...
                    <div>
                        <div class="mb-2">
                            <input wire:model="postId" type="hidden" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900">
                        </div>
                        <div class="mb-2">
                            <label for="title" class="block">Nama</label>
                            <input wire:model="nama" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900">
                        </div>
                        <div class="mb-2">
                            <label for="title" class="block">Kota</label>
                            <input wire:model="kota" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900">
                        </div>
                    </div>
                </form>
            </div>
